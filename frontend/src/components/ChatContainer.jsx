...
const ChatContainer = () => {
  ...
  const getAvatarUrl = (user) =>
    user?.profilePic ||
    `https://ui-avatars.com/api/?name=${user?.username || "U"}&background=6366f1&color=fff&size=36`;
              ...
              >
                ...
                <div
                  className={`max-w-[70%] px-4 py-2.5 ${
                    isMine
                      ? "bg-gradient-to-br from-primary to-primary-dark text-white rounded-2xl rounded-br-md"
                      : "bg-surface-light text-slate-200 rounded-2xl rounded-bl-md"
                  }`}
                >
                  {message.image && (
                    <img
