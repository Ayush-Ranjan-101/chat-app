        ...
        <div className="glass rounded-2xl p-8 glow-primary">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative group">
              <div className="w-32 h-32 rounded-full overflow-hidden ring-4 ring-primary/20 group-hover:ring-primary/40 transition-all duration-300">
                <img
                  src={
                    selectedImage ||
                    authUser?.profilePic ||
                    `https://ui-avatars.com/api/?name=${authUser?.username || "User"}&background=6366f1&color=fff&size=128`
                  }
                  alt="Profile"
              ...
              <label
                ...
                className={`absolute bottom-1 right-1 w-10 h-10 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform shadow-lg ${isUpdatingProfile ? "pointer-events-none animate-pulse" : ""}`}
              >
          ...
          <div className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="px-4 py-3 bg-base-100/50 rounded-xl border border-slate-700/30 text-slate-200">
                {authUser?.username || "—"}
              </div>
            </div>
